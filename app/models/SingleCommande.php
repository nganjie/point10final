...
class SingleCommande{
    ...
    public function Template()
    {
        ...
        >
          ...
          <button type='button' class='open-modal' data-open='modalmodif{$this->id}' style='display:none'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              height='1em'
              viewBox='0 0 512 512'
    ...
    {
        $row=  $row="<tr class='responsive-table__row'>
        <td
          class='responsive-table__body__text responsive-table__body__text--name'
        >
          {$this->nom}
        ...
        <button type='button' class='open-modal' data-open='modalvue{$this->id}'>
                      ...
                      <a href='facture-client/{$this->id}' '><i class='fa-solid fa-circle-check' style='width: 20px;height: 20px;></i><a/>
                      </button>
