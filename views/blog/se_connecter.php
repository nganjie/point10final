...
<html lang="en">
      ...
      <div class="divided_main_content">
        ...
        <section class="body_section">
          <div class="bordered_content">
            ...
            <p style="color:red"><?= isset($_GET['result'])&&$_GET['result']==0?"le mail renseigner est incorrect !":""?><?= isset($_GET['result'])&&$_GET['result']==2?"le mot de passe renseigner est incorrect !":""?></p>
            <form action="connexion_client" method="POST" id="connect_form">
              <input
                type="email"
                name="mail"
                id=""
              ...
              <input type="submit" class="form_btn" value="Se connecter"/>
            </form>
            <div class="green_link">
              pas encore de compte ?
              <a class="" href="creer-compte">Insrcivez vous ici</a>
            </div>
          </div>
        </section>
      </div>
  ...
  <script
    ...
    crossorigin="anonymous"
  ></script>
  <script src="<?= SCRIPTS ?>../js/connexion_client.js">
